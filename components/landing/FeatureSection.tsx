...
export default function FeatureSection() {
  return (
    <section id="features" className="py-20 max-w-6xl mx-auto px-4 sm:px-6 relative">
      {/* Section Header */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 p-8 rounded-3xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-xl shadow-xl relative overflow-hidden group hover:border-indigo-500/40 transition">
          <div className="absolute top-0 right-0 w-64 h-64 bg-indigo-600/10 rounded-full blur-3xl pointer-events-none" />
          
          <div className="w-12 h-12 rounded-2xl bg-indigo-500/10 border border-indigo-500/25 flex items-center justify-center text-indigo-400 mb-6 shadow-lg shadow-indigo-500/10">
        ...
        <div className="p-8 rounded-3xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-xl shadow-xl relative overflow-hidden group hover:border-violet-500/40 transition flex flex-col justify-between">
          <div className="absolute top-0 right-0 w-48 h-48 bg-violet-600/10 rounded-full blur-3xl pointer-events-none" />

          <div>
            <div className="w-12 h-12 rounded-2xl bg-violet-500/10 border border-violet-500/25 flex items-center justify-center text-violet-400 mb-6 shadow-lg shadow-violet-500/10">
          ...
          <div className="mt-6 pt-4 border-t border-slate-800/80 text-[11px] font-mono text-violet-300">
            ✓ 100% Passwordless Entry
          </div>
        </div>

        {/* Bento Card 3: Group Collaboration & Governance (1 col) */}
        <div className="p-8 rounded-3xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-xl shadow-xl relative overflow-hidden group hover:border-emerald-500/40 transition flex flex-col justify-between">
          <div className="absolute top-0 right-0 w-48 h-48 bg-emerald-600/10 rounded-full blur-3xl pointer-events-none" />

          <div>
            <div className="w-12 h-12 rounded-2xl bg-emerald-500/10 border border-emerald-500/25 flex items-center justify-center text-emerald-400 mb-6 shadow-lg shadow-emerald-500/10">
